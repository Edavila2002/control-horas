...
def mostrar_horas_trabajadas():
    ...
    if uploaded_file:
        ...
        if not df_resultado.empty:
            ...
            st.markdown(f"""
<div style="display: flex; justify-content: center; align-items: center; margin-top: 20px; padding: 15px; background-color: #e6f3ff; border-radius: 10px; border: 1px solid #b8daff;">
    <h3 style="margin: 0; font-size: 20px; color: #0366d6;">🕒 Total de Horas:</h3>
    <p style="margin: 0 0 0 10px; font-size: 28px; font-weight: bold; color: #0366d6;">{total_horas_filtrado}</p>
</div>
""", unsafe_allow_html=True)
...
def mostrar_horas_por_servicio():
    ...
    if st.session_state.df_mostrar is not None:
        ...
        # Mostrar total de horas en un cuadro destacado debajo de la tabla con un diseño mejorado y un emoji
        st.markdown(f"""
    <div style="display: flex; justify-content: flex-start; align-items: center; margin-top: 20px; padding: 15px; background-color: #e6f3ff; border-radius: 10px; border: 1px solid #b8daff;">
        <h3 style="margin: 0; font-size: 20px; color: #0366d6;">🕒 Total de Horas:</h3>
        <p style="margin: 0 0 0 10px; font-size: 28px; font-weight: bold; color: #0366d6;">{total_horas_filtrado}</p>
    </div>
    """, unsafe_allow_html=True)
